// @components/componentry/Card.tsx
// import { HeartIcon } from '@heroicons/react/solid';
// import Image from 'next/image';
// import Link from 'next/link';
// import PropTypes from 'prop-types';

// const Card = ({ id = '', image = '', title = '', guests = 0, beds = 0, baths = 0, price = 0, favorite = false, onClickFavorite = () => null }) => (
//     <Link
...
//                 <HeartIcon className={`w-7 h-7 drop-shadow-lg transition ${favorite ? 'text-red-500' : 'text-white'}`} />
//             </button>
//         </div>
