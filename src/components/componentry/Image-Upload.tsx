...
//                 className={'relative aspect-w-16 aspect-h-9 overflow-hidden rounded-md disabled:opacity-50 disabled:cursor-not-allowed transition group focus:outline-none'}
...
//                             </div>
//                             <span className='text-xs font-semibold text-gray-500 transition'>{updatingPicture ? 'Uploading...' : 'Upload'}</span>
//                         </div>
//                     ) : null}
//                     <input
//                         ref={pictureRef}
