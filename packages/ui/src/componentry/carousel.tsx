...
import { Button } from "@/componentry/button";
...
>(
  (
    ...
    let [canScrollPrev, setCanScrollPrev] = React.useState<boolean>(false);
    let [canScrollNext, setCanScrollNext] = React.useState<boolean>(false);
